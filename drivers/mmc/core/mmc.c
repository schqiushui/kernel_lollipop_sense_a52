...
static const struct mmc_fixup mmc_fixups[] = {
	...
	MMC_FIXUP("Q7XSAB", CID_MANFID_SAMSUNG, CID_OEMID_ANY, add_quirk_mmc,
              MMC_QUIRK_CACHE_DISABLE),

	MMC_FIXUP("AWMB3R", CID_MANFID_SAMSUNG, CID_OEMID_ANY, add_quirk_mmc,
              MMC_QUIRK_CACHE_DISABLE),

	MMC_FIXUP("HAG2e^E", CID_MANFID_HYNIX, CID_OEMID_ANY, add_quirk_mmc,
              MMC_QUIRK_CACHE_DISABLE),
