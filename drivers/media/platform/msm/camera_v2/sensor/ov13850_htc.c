...
#define ov13850_SENSOR_NAME "ov13850_htc"
#define PLATFORM_DRIVER_NAME "msm_camera_ov13850_htc"
#define ov13850_obj ov13850_htc_##obj
...
static struct msm_sensor_power_setting ov13850_power_down_setting[] = {
	{
		.seq_type = SENSOR_I2C_MUX,
		.seq_val = 0,
		.config_val = 0,
...
static const struct of_device_id ov13850_dt_match[] = {
	{.compatible = "htc,ov13850_htc", .data = &ov13850_s_ctrl},
	{}
};
...
static const char *ov13850NAME = "ov13850_htc";
...
static int ov13850_sysfs_init(void)
{
	...
	if (android_ov13850 == NULL) {
		pr_info("ov13850_htc_sysfs_init: subsystem_register " \
		"failed\n");
		ret = -ENOMEM;
		return ret ;
	}
	pr_info("ov13850_htc:sysfs_create_file\n");
...
static struct msm_sensor_ctrl_t ov13850_s_ctrl = {
	...
	.power_setting_array.power_down_setting = ov13850_power_down_setting,
	.power_setting_array.size_down = ARRAY_SIZE(ov13850_power_down_setting),
...
MODULE_DESCRIPTION("ov13850_htc");
